...
if (base.f_mode !== 'proxy-windows' || punched.f_mode !== 'proxy-windows') process.exit(2)
if (base.measured?.source_looped) process.exit(2)
if (!(brolled.scalar > base.scalar)) process.exit(3)
if (agent.status !== 'commit') process.exit(4)
